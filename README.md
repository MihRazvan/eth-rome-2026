...
[Short manual test checklist](docs/CUTOUT-MANUAL-TEST.md) · [Teammate brief and judge demo guide](docs/CUTOUT-TEAM-BRIEF.md) explains the product, presentation sequence, real end-to-end test, and current limits.
