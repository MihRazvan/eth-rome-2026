...
**Latest milestone: [wallet-separated pilot](pilot/README.md) at http://127.0.0.1:18888.** It adds holder-local proof import, wallet-owned persistent recipient keys, a durable issuer allocator and an actual two-client Chromium rehearsal. Start with its [runbook](pilot/RUNBOOK.md) and [acceptance](pilot/ACCEPTANCE.md). The original single-machine feasibility helper described below remains available on18787; its missing key-delivery/manual-index limitations are historical and are addressed in the separate pilot, with the pilot's remaining boundaries explicitly recorded.
