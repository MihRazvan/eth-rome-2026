...
export function mountCutoutDemo(container: HTMLElement): () => void {
  ...
  async function open() {
    ...
    try {
      ...
      setText(".cd-cut-hint", "CUT OPEN / VERIFIED");
      message(
