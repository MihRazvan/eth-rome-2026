...
The next evidence should come from authorized public writes and the [real participant protocol](PILOT.md), not additional simulated customer endorsements. The existing EXIT and REPRISE implementations/history remain preserved.
