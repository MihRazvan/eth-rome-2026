...
13 September2026. Final application source **4f67608**. [Deployment](deployment.json), [build hashes](build.json), [original decision record](https://github.com/MihRazvan/eth-rome-2026/blob/c50937c/docs/cutout/UX-PRIORITIES.md).
