...
4. **Reviewer → Tasks:** open the matching listing and **View verified scope**. Check its terms. Choose **Accept this task**, complete automatic setup if prompted, wait for the local proof, then **Confirm acceptance** and sign on Fuji. A proof alone does not reserve the task.
