# Cutout — bounty and submission map

[Docs](../README.md) · [Evidence](EVIDENCE.md) · [Presenter guide](../CUTOUT-PRESENTER-GUIDE.md)
...
| Entry | Why Cutout fits | What judges should inspect |
| --- | --- | --- |
...
The [current Team1 rules](https://build.avax.network/events/73a939b1-6d35-4847-9388-320024638249) require one track per project and a complete testnet flow with verifiable onchain activity. Track A accepts stablecoin payment applications; a new stablecoin issuance is not a stated requirement. Cutout uses existing canonical Fuji test USDC.

The [current Arkiv hub](https://hub.arkiv.network/ethrome) allows only one award per team; qualifying projects automatically enter Best Use consideration. Mission 01 requires replacing an existing indexer path, which Cutout does not claim. Current official pages were checked on 12 September 2026; they supersede conflicting older copied currency/scoring details. [Supplied Swarm brief](../review-pass/supplied-bounties.txt) makes Swarm ID optional.
...
| Public app and account-free walkthrough | [Cutout](https://cutout-ethrome-2026.vercel.app), [judge tutorial](../CUTOUT-JUDGE-TUTORIAL.md) — available |
