...
- Current application source at this documentation pass: **`5530ce8`**. Later documentation-only commits do not change that deployed application.
- Deployment: **`dpl_9KwmtoqwTKQxUWNevCFThysqxuu8`**; [build/deployment records](../design/cutout/evidence/wallet-role/README.md).
